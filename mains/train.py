...
def train(config, do_mp=False, fold_idx=0):
    ...
    # losses
    losses = dict()
    # TODO: revise names for multiple losses
    names = ["loss"]
    for name in names:
        kwargs = {}
    ...
    for t in range(repeat_time):
        ...
        for k in range(k_time):
            ...
            models = dict()
            # TODO: revise names for multiple models
            names = ["model"]
            for name in names:
            ...
            # optimizers
            optimizers = dict()
            # TODO: revise names for multiple optimizers
            names = ["model"]
            for name in names:
            ...
            lr_schedulers = dict()
            # TODO: revise names for multiple lr_schedulers
            names = ["model"]
            for name in names:
