...
class FCN32s(nn.Module):
    def __init__(self, use_pretrained=True, num_classes=7):
	...
	# conv1
        ...
        vgg = vgg16(pretrained=use_pretrained)
    ...
    def copy_params_from_vgg16(self, vgg):
        features = [
...
class FCN16s(nn.Module):
    def __init__(self, use_pretrained=True, num_classes=7, FCN32s_path=None):
	...
	# conv1
        ...
        if FCN32s_path:
            fcn32s = FCN32s()
            state_dict = torch.load(FCN32s_path)['state_dict']
