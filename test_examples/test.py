...
def main(cfg):
    ...
    # dataloader
    testloader = cfg.init_obj('data_loader', module_data, mode=cfg.mode)

    # build model architecture
    model = cfg.init_obj('arch', module_arch, mode='test')
    print(model)
    ...
    print('Loading model: {} ...'.format(cfg.resume))
    ...
    with torch.no_grad():
        ...
        out_csv = os.path.join(cfg.out_dir, 'test_pred.csv')
